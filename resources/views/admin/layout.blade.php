            ...
            <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
                <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start"
                        id="nav_accordion">
                        <li class="nav-item">
                            <a class="nav-link" style="color:aqua" href="#">Library Managment</a>
                        </li>
                        <li class="nav-item has-submenu">
                            ...
                            <ul class="collapse list-unstyled submenu" id="submenu2" data-bs-parent="#nav_accordion">
                                <li><a class="nav-link" style="color: rgb(232, 238, 232)" href="/admin/book/add">◯
                                        Add</a></li>
                                <li><a class="nav-link" style="color: rgb(240, 245, 240)" href="/admin/book/index">◯
                                        View</a></li>
                            </ul>
                        </li>
                        <li class="nav-item has-submenu">
